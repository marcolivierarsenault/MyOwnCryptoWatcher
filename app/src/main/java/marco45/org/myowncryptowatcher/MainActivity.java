...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCrypto.add(CryptoCurency.newInstance("Bitcoin",settings.getString("Bitcoin", "0"),"btc_cad","https://files.coinmarketcap.com/static/img/coins/128x128/bitcoin.png",this));
